...
public class ClickSpawner : MonoBehaviour
{
    ...
    [SerializeField] protected GameObject alternatePrefabsToSpawn;
    [SerializeField] protected bool useAlternatePrefab;
    ...
    public void setUseAlternatePrefab(bool value)
    {
        useAlternatePrefab = value;
    }
    protected virtual GameObject spawnObject()
    {
        ...
        newObject = useAlternatePrefab ?
        Instantiate(alternatePrefabsToSpawn, positionOfSpawnedObject, rotationOfSpawnedObject) :
